...
// BitwiseHelper.cpp : Defines the class behaviors for the application.
//
...
// CBitwiseHelperApp construction
...
CBitwiseHelperApp::CBitwiseHelperApp()
{
	...
	SetAppID(_T("BitwiseHelper.AppID.NoVersion"));
...
CBitwiseHelperApp theApp;


// CBitwiseHelperApp initialization

BOOL CBitwiseHelperApp::InitInstance()
{
...
int CBitwiseHelperApp::ExitInstance()
{
...
void CBitwiseHelperApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
void CBitwiseHelperApp::LoadCustomState()
{
}

void CBitwiseHelperApp::SaveCustomState()
{
}
