================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : BitwiseHelper Project Overview
===============================================================================

The application wizard has created this BitwiseHelper application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your BitwiseHelper application.

BitwiseHelper.vcxproj
...
BitwiseHelper.h
    ...
    CBitwiseHelperApp application class.

BitwiseHelper.cpp
    This is the main application source file that contains the application
    class CBitwiseHelperApp.
...
res\BitwiseHelper.ico
    This is an icon file, which is used as the application's icon.  This
    icon is included by the main resource file BitwiseHelper.rc.

res\BitwiseHelper.rc2
...
res\Toolbar.bmp
    ...
    update the IDR_MAINFRAME TOOLBAR array in BitwiseHelper.rc to add
    toolbar buttons.
/////////////////////////////////////////////////////////////////////////////
...
hlp\BitwiseHelper.hhp
    This file is a help project file. It contains the data needed to
    compile the help files into a .chm file.

hlp\BitwiseHelper.hhc
    This file lists the contents of the help project.

hlp\BitwiseHelper.hhk
...
StdAfx.h, StdAfx.cpp
    ...
    named BitwiseHelper.pch and a precompiled types file named StdAfx.obj.

Resource.h
    This is the standard header file, which defines new resource IDs.
    Microsoft Visual C++ reads and updates this file.

BitwiseHelper.manifest
